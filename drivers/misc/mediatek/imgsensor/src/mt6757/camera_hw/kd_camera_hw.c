...
#else // #if defined(IMX234_MIPI_RAW)
		{GPIO_UNSUPPORTED, GPIO_MODE_GPIO, Vol_High},	/* for SUB_AVDD; */
#endif // #if defined(IMX234_MIPI_RAW)
		{GPIO_UNSUPPORTED, GPIO_MODE_GPIO, Vol_Low},	/* for SUB_DVDD; */
		{GPIO_UNSUPPORTED, GPIO_MODE_GPIO, Vol_High},	/* for SUB_DOVDD; */
		{GPIO_UNSUPPORTED, GPIO_MODE_GPIO, Vol_High},	/* for MAIN2_AVDD; */
		{GPIO_SUPPORTED, GPIO_MODE_GPIO, Vol_High},	/* for MAIN2_DVDD; */
...
#endif
#if defined(IMX219_CHICONY_MIPI_RAW)
		{SENSOR_DRVNAME_IMX219_CHICONY_MIPI_RAW,
			{
				{SensorMCLK, Vol_High, 5},
				{AVDD, Vol_2800, 0},
				{DOVDD, Vol_1800, 0},
...
#else // #ifdef MTK_ORIGINAL
#if defined(IMX234_MIPI_RAW)
				if (pwInfo.Voltage == Vol_1000) {
					pwInfo.Voltage = Vol_1000;
					PK_DBG("[CAMERA SENSOR] Sub camera VCAM_D power 1.0V\n");
				}
#else
				if (pwInfo.Voltage == Vol_1200) {
					pwInfo.Voltage = Vol_1220;
