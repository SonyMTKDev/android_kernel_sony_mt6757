...
static struct snd_soc_dai_link mt_soc_extspk_dai[] = {
	{
		...
		.ignore_suspend = 1,
		.ignore_pmdown_time = true,
#elif defined(CONFIG_SND_SOC_RT5508)
               .codec_dai_name = "rt5508-aif1",
               .codec_name = "RT5508_MT",
               .ignore_suspend = 1,
               .ignore_pmdown_time = true,
#elif defined(CONFIG_SND_SOC_TFA9891)
		.codec_dai_name = "tfa98xx-aif-1-36",
		.codec_name = "tfa98xx.1-0036",
		.ignore_suspend = 1,
		.ignore_pmdown_time = true,
