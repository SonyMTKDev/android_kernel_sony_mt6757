...
//USB eye diagram parameter -S
	U3PhyWriteField32((phys_addr_t) (uintptr_t) U3D_USBPHYACR1, RG_USB20_VRT_VREF_SEL_OFST, RG_USB20_VRT_VREF_SEL, 3);
	U3PhyWriteField32((phys_addr_t) (uintptr_t) U3D_USBPHYACR1, RG_USB20_TERM_VREF_SEL_OFST, RG_USB20_TERM_VREF_SEL, 1);
	U3PhyWriteField32((phys_addr_t) (uintptr_t) U3D_USBPHYACR5, RG_USB20_HSTX_SRCTRL_OFST, RG_USB20_HSTX_SRCTRL, 1);
	U3PhyWriteField32((phys_addr_t) (uintptr_t) U3D_USBPHYACR6, RG_USB20_PHY_REV_6_OFST, RG_USB20_PHY_REV_6, 0x01);
//USB eye diagram parameter -E
	/*Wait 800 usec */
	udelay(800);
...
//USB eye diagram parameter -S
	...
	U3PhyWriteField32((phys_addr_t) (uintptr_t) U3D_USBPHYACR5, RG_USB20_HSTX_SRCTRL_OFST, RG_USB20_HSTX_SRCTRL, 1);
	U3PhyWriteField32((phys_addr_t) (uintptr_t) U3D_USBPHYACR6, RG_USB20_PHY_REV_6_OFST, RG_USB20_PHY_REV_6, 0x01);
	os_printk(K_ERR, "[USB] U3D_USBPHYACR1 0x%x,U3D_USBPHYACR5 0x%x ,U3D_USBPHYACR6 0x%x\n",
		U3PhyReadReg32((phys_addr_t) (uintptr_t) U3D_USBPHYACR1),
		U3PhyReadReg32((phys_addr_t) (uintptr_t) U3D_USBPHYACR5),
		U3PhyReadReg32((phys_addr_t) (uintptr_t) U3D_USBPHYACR6));
//USB eye diagram parameter -E
