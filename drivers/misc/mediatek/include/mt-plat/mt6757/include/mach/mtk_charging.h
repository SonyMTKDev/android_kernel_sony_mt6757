...
//CEI comment start
//parameter setting
#define USB_IBAT_CURRENT					CHARGE_CURRENT_525_00_MA	/*Will set 512mA to charger IC*/
//CEI comment end
...
//CEI comment start
//parameter setting
#define APPLE_2_1A_CHARGER_CURRENT          CHARGE_CURRENT_1500_00_MA /*ori = 800mA */
//CEI comment end
...
#define JEITA_TEMP_POS_10_TO_POS_45_CV_VOLTAGE		BATTERY_VOLT_04_352000_V
#define JEITA_TEMP_POS_0_TO_POS_10_CV_VOLTAGE		BATTERY_VOLT_04_200000_V
//CEI comment end
...
#define MTK_CV_VOLTAGE 4352000 /* uV */
//CEI comment end
//CEI comments, soft charge 3.0 start
#define MTK_SC30_LOWER_CV_VOLTAGE 4304000 /* uV */
