...
#else
#define MAX_AC_CHARGING_TIME                   (8*60*60)	/* 8hr */
#define MAX_CHARGING_TIME                   (20*60*60)	/* 20hr */
#endif
...
extern kal_bool bat_resume_flag;//CEI comment, fix screen on too late due to PE detection
