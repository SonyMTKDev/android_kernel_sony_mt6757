...
static void __init map_mem(pgd_t *pgd)
{
	...
	//create_mapping_noalloc((unsigned long long)CCI_KLOG_START_ADDR_PHYSICAL, (unsigned long)MSM_KLOG_BASE, (unsigned long long)CCI_KLOG_SIZE,PAGE_KERNEL);
	//__create_pgd_mapping(init_mm.pgd, (unsigned long long)CCI_KLOG_START_ADDR_PHYSICAL, (unsigned long)MSM_KLOG_BASE, (unsigned long long)CCI_KLOG_SIZE, PAGE_KERNEL, early_pgtable_alloc);
	__create_pgd_mapping(pgd, (unsigned long long)CCI_KLOG_START_ADDR_PHYSICAL, (unsigned long)MSM_KLOG_BASE, (unsigned long long)CCI_KLOG_SIZE, PAGE_KERNEL, early_pgtable_alloc);
