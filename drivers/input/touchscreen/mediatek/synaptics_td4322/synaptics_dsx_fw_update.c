...
#include "firmware/PR2526806-td4322-i2c-innolux6p_sony_00060009.h"
#endif
...
static ssize_t fwu_sysfs_fw_is_update_show(struct device *dev,
		struct device_attribute *attr, char *buf)
{
	return snprintf(buf, PAGE_SIZE, "%s\n", synaptics_fw_is_update ? "true" : "false");
}
