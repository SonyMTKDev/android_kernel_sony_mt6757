...
static struct LCM_setting_table lcm_initialization_cmd_code_setting[] = {
	...
	//R(+) MCR cmd
  	{ 0xB0,16, {0x00,0x00,0x00,0x25,0x00,0x58,0x00,0x7E,0x00,0x9D,0x00,0xB7,0x00,0xCD,0x00,0xE1}},
  	{ 0xB1,16, {0x00,0xF3,0x01,0x2B,0x01,0x56,0x01,0x94,0x01,0xC3,0x02,0x06,0x02,0x3D,0x02,0x3F}},
  	{ 0xB2,16, {0x02,0x75,0x02,0xB4,0x02,0xDD,0x03,0x11,0x03,0x35,0x03,0x5F,0x03,0x6C,0x03,0x7B}},
  	{ 0xB3,12, {0x03,0x8B,0x03,0x9E,0x03,0xB4,0x03,0xC9,0x03,0xD7,0x03,0xD8}},
	//G(+) MCR cmd
  	{ 0xB4,16, {0x00,0x00,0x00,0x25,0x00,0x58,0x00,0x7E,0x00,0x9D,0x00,0xB7,0x00,0xCD,0x00,0xE1}},
  	{ 0xB5,16, {0x00,0xF3,0x01,0x2B,0x01,0x56,0x01,0x94,0x01,0xC3,0x02,0x06,0x02,0x3D,0x02,0x3F}},
  	{ 0xB6,16, {0x02,0x75,0x02,0xB4,0x02,0xDD,0x03,0x11,0x03,0x35,0x03,0x5F,0x03,0x6C,0x03,0x7B}},
  	{ 0xB7,12, {0x03,0x8B,0x03,0x9E,0x03,0xB4,0x03,0xC9,0x03,0xD7,0x03,0xD8}},
	//B(+) MCR cmd
  	{ 0xB8,16, {0x00,0x00,0x00,0x25,0x00,0x58,0x00,0x7E,0x00,0x9D,0x00,0xB7,0x00,0xCD,0x00,0xE1}},
  	{ 0xB9,16, {0x00,0xF3,0x01,0x2B,0x01,0x56,0x01,0x94,0x01,0xC3,0x02,0x06,0x02,0x3D,0x02,0x3F}},
  	{ 0xBA,16, {0x02,0x75,0x02,0xB4,0x02,0xDD,0x03,0x11,0x03,0x35,0x03,0x5F,0x03,0x6C,0x03,0x7B}},
  	{ 0xBB,12, {0x03,0x8B,0x03,0x9E,0x03,0xB4,0x03,0xC9,0x03,0xD7,0x03,0xD8}},
  	//page selection cmd start
	{ 0xFF,1,{0x21}},
	{REGFLAG_DELAY, 1, {}},
	{ 0xFB,1,{0x01}},
	...
	{ 0x35,1,{0x00}},
	{ 0x44,2,{0x07, 0x7F}}, //fix LCM tearing issue
...
static void lcm_suspend(void)
{
	...
	init_lcm_registers_sleep_in();
       ...
       //Keep LCM reset high to fix 2mA power leakae
	//pull_reset_pin_low();
	//MDELAY(5);
