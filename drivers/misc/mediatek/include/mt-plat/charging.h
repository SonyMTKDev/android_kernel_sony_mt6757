...
//Add 500ms thread to prevent backboost
	CHARGING_CMD_PLUG_OUT,
	CHARGING_CMD_PLUG_IN,
	CHARGING_CMD_CHECK_BACKBOOST,
//CEI comment end
	CHARGING_CMD_NUMBER
} CHARGING_CTRL_CMD;
...
//CEI comment start//
//parameter setting
	CHARGE_CURRENT_2432_00_MA = 243200,
//CEI comment end//
